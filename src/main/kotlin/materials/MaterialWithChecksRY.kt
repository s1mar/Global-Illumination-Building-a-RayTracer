...
class MaterialWithChecksRY(
    private val uniformMaterial1: MaterialUniform = MaterialUniform(Point(255f,0f,0f)),
    private val uniformMaterial2: MaterialUniform = MaterialUniform(Point(255f,255f,0f)),
